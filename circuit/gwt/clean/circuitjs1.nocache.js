function circuitjs1() {
    var O = 'bootstrap'
      ...
      , Zb = 'circuitjs1.devmode.js'
      , $b = '0EC7F61C9589882CC7D3E83DB9C79772'
      , _b = '7973F92D4929DB0F2AD1B1135DA03CF0'
      , ac = '879D0985DF5079D525E19DB94EA0E4D6'
      , bc = 'E0B2C8FC17C81DCF113146EE97180DBE'
      , cc = 'FC395F7700B380C98DBA0AA8AFABDEC8'
      , dc = ':'
      , ec = '.cache.js'
      , fc = 'link'
      , gc = 'rel'
      ...
      , oc = 'file:'
      , pc = '_gwt_dummy_'
      , qc = '__gwtDevModeHook:circuitjs1'
    ...
    function A(k) {
        ...
        if (circuitjs1.__errFn) {
            n.onerror = function() {
                circuitjs1.__errFn(S, new Error(mb + code))
            }
        }
    ...
    function B() {
        ...
        for (var g = V, h = f.length; g < h; ++g) {
            var i = f[g], j = i.getAttribute(pb), k;
            if (j) {
                j = j.replace(qb, ab);
                if (j.indexOf(rb) >= V) {
                    continue
    ...
    var H = F();
    if (o) {
        var I = !!(o.location.protocol == nc || o.location.protocol == oc);
