...
const drawMove = new DrawTool('draw-move', 'drawMove', false, '線のスタイル', [false, false], false, false, false);
const drawDelete = new DrawTool('draw-delete', 'drawDelete', false, '線のスタイル', [false, false], false, false, false);
const lineHorTool = new DrawTool('line-horizontal', 'lineHor', false, '線のスタイル', [true, false], true, false, false);
const lineVerTool = new DrawTool('line-vertical', 'lineVer', false, '線のスタイル', [true, false], true, false, false);
const lineCircleTool = new DrawTool('line-circle', 'lineCircle', false, '線のスタイル', [true, false], true, false, true);
